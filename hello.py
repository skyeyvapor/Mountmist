...
# import Flask class from flask module in virtualenv
# request function will have all the data from the client to the server
app = Flask(__name__)
# instantiate Flask by passing a identifier(here we use MAGICAL __name__ which means name of this file as it was called.
# it is called from shell )
